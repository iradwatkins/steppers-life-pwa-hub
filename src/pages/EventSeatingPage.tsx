          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <Card className="bg-gradient-to-r from-purple-50 to-blue-50 border-purple-200">
              <CardHeader>
                ...
                <CardDescription>
                  For complex venues, upload your existing seating chart and map individual seats
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-medium mb-1">Upload Custom Seating Chart</h4>
                    <p className="text-sm text-muted-foreground">
                      Perfect for theaters, concert halls, and large venues with detailed seating layouts
                    </p>
                  </div>
                  <Button 
                    type="button" 
